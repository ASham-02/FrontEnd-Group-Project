...
// Refactor -> create a pure to generate the card - takes a character object and modifies the DOM accordingly
        ...
        fetch('http://127.0.0.1:8080/api/characters', {
            ...
            .then((data) => {
                ...
                if (artwork) {
                    ...
                    document.getElementById('card-artwork').style.display =
                        'block';
                } else {
                    document.getElementById('card-artwork').style.display =
                        'none';
